            ...
            <form action="register" method="post">
              ...
              <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control border-0 border-bottom rounded-0" name="user" id="user" placeholder="name@example.com" required>
                    <label for="user" class="form-label">Tên người đăng ký</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating mb-3">
