		...
		<div class="col-md-2">
			...
			<h4 class="text-center">Các mặt hàng của bạn</h4>
					<div class="card-body"></div>
					  ...
					  <tbody>
						    <tr>					    
						      <th scope="col"><a href="index.jsp" class="text-danger">Tất cả mặt hàng</a></th>
						    </tr>
						     <tr>					    
						    ...
						    <tr>
						      <th scope="col"><a href="All_Diverse_Product.jsp">Các mặt hàng khác</a></th>
						    </tr>
					  </tbody>
					</table>
                         ...
                         <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem"><%=p.getCategory() %></div>
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <!-- Product price-->
                                    <h5 class="">Giá hiện tại: <%=p.getPrice() %>
                                    </h5>
